...
def main():
    ...
    st.title("NLP Web App Project") 
    with st.expander("About the Web App",expanded=False):
     st.write("""
        This is an application that integrates two use famous case applications of Natural Language Processing (NLP) that are the text summarization of long passages and detection of the sentiment in the text.
     """)
    
    #Getting the text from the user
    task =  st.selectbox("Select an Action You Want To Perform ",("None","Summarize the Text","Detect Sentiment in Text"))
        #Text Summarizer 
